        ...
        >
          <div>
            ...
            <p style={{ fontSize: 15, color: "var(--muted)", lineHeight: 1.8, maxWidth: 440 }}>
              Мы не корпорация. Не тратим ваши деньги на бюрократию и менеджеров менеджеров.
              Работаем с логистикой, производством, строительством и медициной — там, где есть
              реальные процессы и живые люди, которым нужно избавиться от рутины.
            </p>
          </div>
