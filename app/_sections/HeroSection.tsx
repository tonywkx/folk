  ...
  return (
    ...
    >
      ...
      >
        ...
        >
         Строим веб и мобильные приложения под заказ — корпоративные системы, полевые инструменты, продукты для пользователей. Встраиваем ИИ там, где это даёт реальный результат.
        </p>
